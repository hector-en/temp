...
10. Conditional ANX files required/recommended by the selected batch, especially `SPEC_Layer03_06-nca-art-base-ANX01_spectral_operator_dsl_bridge.md` for Batches 06-12 according to the annex request table above
